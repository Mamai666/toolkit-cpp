#ifndef TTCPSERVERASYNC_H
#define TTCPSERVERASYNC_H
...
public:
    ...
    TTcpServerAsync( ) : m_ioservice( ), m_acceptor( m_ioservice ), m_connections( ) { }
    ...
    void do_async_read( con_handle_t con_handle ) {
            auto handler = boost::bind( &TTcpServerAsync::handle_read, this, con_handle, boost::asio::placeholders::error, boost::asio::placeholders::bytes_transferred );
    ...
    void handle_accept( con_handle_t con_handle, boost::system::error_code const & err ) {
            if( !err ) {
                    ...
                    auto handler = boost::bind( &TTcpServerAsync::handle_write, this, con_handle, buff, boost::asio::placeholders::error );
    ...
    void start_accept( ) {
            ...
            auto handler = boost::bind( &TTcpServerAsync::handle_accept, this, con_handle, boost::asio::placeholders::error );
