...
//#define ELPP_BOOST_LOGGING // Осторожно! ТЯнет за собой весь буст!
#define ELPP_STL_LOGGING // You can log your STL templates including most containers
//#define ELPP_FEATURE_CRASH_LOG // Applicable to GCC only. Enables stacktrace on application crash
#define ELPP_THREAD_SAFE // Enables thread-safety - make sure -lpthread linking for linux.
//#define ELPP_FORCE_USE_STD_THREAD // Forces to use C++ standard library for threading (Only useful when using ELPP_THREAD_SAFE
//#define ELPP_ASYNC_LOGGING
//#define ELPP_HANDLE_SIGABRT

#define ELPP_THREADING_ENABLED 1 // Обязательно для Visual C++

//#define ELPP_DISABLE_DEFAULT_CRASH_HANDLING

#define ELPP_NO_DEFAULT_LOG_FILE // Отключение файла по умолчанию (myeasylog.log)
//******************************************************
