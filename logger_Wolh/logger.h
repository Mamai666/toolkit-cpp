...
extern void LogSetSingleFileMode();
extern void LoadLogSettings(const std::string &logPath, const std::string &prefix, bool disableStdOut = false, bool verboseLogs = false);
extern void CloseLog();

class PGE_LoggerRAII
{
public:
    PGE_LoggerRAII(const std::string &logPath, const std::string &prefix, bool disableStdOut = false, bool verboseLogs = false)
    {
        LoadLogSettings(logPath, prefix, disableStdOut, verboseLogs);
    }
