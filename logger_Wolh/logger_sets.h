...
public:
    ...
    static int64_t      m_bytesWritten;
    static int64_t      m_bytesWrittenMax;
    //! Is logging system is enabled
    static bool  m_enabled;
    //! Is logging system is enabled
    static bool  m_singleFile;
    ...
    static void LoadLogSettings(const std::string &logPath, const std::string &prefix, bool disableStdOut = false, bool verboseLogs = false);
